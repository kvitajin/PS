...
/////////////////////////kopirovano z : https://github.com/pod32g/MD5/blob/master/md5.c/////////////////////////////////
#include <cstring>
#include <cstdio>
#include <cstdlib>
#include <cstring>
...
void makeHashes(std::vector<std::string> &words){
    ...
    for (int i = 0; i < words.size(); ++i) {
        const char* convertedWord=words[i].c_str();

        uint8_t result[16];
        md5((uint8_t*) convertedWord, words[0].size(), result);
...
//    std::pair<std::string,std::string> highest = *final.rbegin();          // last element
//    auto it = final.begin();
//    do {
//        std::cout << it->first << " => " << it->second << '\n';
//    } while ( final.value_comp()(*it++, highest) );
